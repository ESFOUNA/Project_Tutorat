<header>
    <nav class="navbar navbar-expand-lg navbar-light custom-navbar py-3">
        <div class="container">
            <a class="navbar-brand custom-brand" href="{{ route('home') }}">tutorat</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('jobs') }}">trouver cours</a>
                    </li>
                </ul>
                <div class="d-flex">
                    @if(!Auth::check())
                    ...
                    @endif
                    <a class="btn btn-primary custom-btn" href="{{ route('employee_posts.create') }}">publier un cours</a>
                </div>
            </div>
        </div>
    </nav>
