                ...
                <form action="{{ route('admin.jobs.update', $employeePost->id) }}" method="POST" id="createJobForm" name="createJobForm">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body p-4">
                            <h3 class="fs-4 mb-4">Cours Details</h3>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="employee_class_id" class="mb-2">Cours <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="vacancy" class="mb-2">Durée estimée  <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-4">
                                <label for="responsibility" class="mb-2">Avantages du tutorat</label>
                                <textarea class="form-conrtol" name="responsibility" id="responsibility" cols="5" rows="5" placeholder="Avantages du tutorat">{{ old('responsibility', $employeePost->responsibility) }}</textarea>
                        ...
                        <div class="card-footer p-4">
                            <button type="submit" class="btn botton btn-primary">Update Cours</button>
                        </div>
                    </div>
                </form>
