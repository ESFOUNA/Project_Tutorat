                ...
                <form action="{{ route('employee_posts.update', $employeePost->id) }}" method="POST" id="createJobForm" name="createJobForm">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="employment_type_id" class="mb-2">Type de tutorat <span class="text-danger">*</span></label>
                                    <select class="form-select" name="employment_type_id" id="employment_type_id">
                                        <option value="">Type de tutorat</option>
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="vacancy" class="mb-2">Durée du tutorat <span class="text-danger">*</span></label>
                        ...
                        <div class="card-footer p-4">
                            <button type="submit" class="btn btn-primary">Update Cours </button>
                        </div>
                    </div>
                </form>
