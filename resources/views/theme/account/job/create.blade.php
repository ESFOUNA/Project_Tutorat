            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4 shadow-sm">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">publier un cours</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <form action="{{ route('employee_posts.store') }}" method="POST" id="createJobForm" name="createJobForm">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <h3 class="fs-4 mb-4 text-primary">Cours Details</h3>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="title" class="form-label">Title <span class="text-danger">*</span></label>
                                    <input type="text" placeholder="cours Title" id="title" name="title" class="form-control" value="{{ old('title') }}">
                                    @error('title')
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="employee_class_id" class="form-label">Cours <span class="text-danger">*</span></label>
                                    <select name="employee_class_id" id="employee_class_id" class="form-select">
                                        <option value="">Selectionnez un count_chars</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="employment_type_id" class="form-label">Type de tutorat <span class="text-danger">*</span></label>
                                    <select class="form-select" name="employment_type_id" id="employment_type_id">
                                        <option value="">Select Type de tutorat</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="vacancy" class="form-label">Durée estimée <span class="text-danger">*</span></label>
                                    <input type="number" min="1" placeholder="Durée estimée *weeks*" id="vacancy" name="vacancy" class="form-control" value="{{ old('vacancy') }}">
                                    @error('vacancy')
                                        <div class="text-danger mt-2">
                                           {{ $message }}
                                        </div>
                                ...
                                <!-- <div class="col-md-6 mb-3">
                                    <label for="location" class="form-label">Lieu du cours <span class="text-danger">*</span></label>
                                    <input type="text" placeholder="Lieu du cours" id="location" name="location" class="form-control" value="{{ old('location') }}">
                                    @error('location')
                                        <div class="text-danger mt-2">
                                           {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3">
                                <label for="benefits" class="form-label">Avantages du tutorat</label>
                                <textarea class="form-control" name="Avantages du tutorat" id="benefits" rows="5" placeholder="Avantages du tutorat">{{ old('benefits') }}</textarea>
                                @error('benefits')
                                    <div class="text-danger mt-2">
                                       {{ $message }}
                                    </div>
